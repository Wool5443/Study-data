...
\begin{figure}[H]
    ...
    \caption*{Оранжевый - теория, синий - эксперимент}
\end{figure}
...
\subsection*{Вывод}
Видно, что для кувшина графики больше совпадают с теорией, но видно,
что реальность довольно сильно отличается от теории.
