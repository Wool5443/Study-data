...
исследовать явления появления кумулятивной струи при падении капли
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=0.5\textwidth]{img/Cumulative effect.png}
...
\begin{equation}
    A_\text{тяж} = \int_{0}^{l} \pi{r_c^2}\rho{g}dy =
