...
\author{
    ...
    \begin{tabular}{cc}
        \begin{tabular}{|l|c|c|}
            \hline
            \textbf{Раздел} & \makecell{\textbf{Максимальная} \\
            \textbf{оценка}} & \makecell{\textbf{Итоговая} \\
            \textbf{оценка}} \\\hline
            Работа программы & $1$ & \\\hline
            Тесты & $1$ & \\\hline
            \makecell[l]{Правильность \\ алгоритма} & $3$ & \\\hline
            Листинг & $0,5$ & \\\hline
            Ответа на вопросы & $2$ & \\\hline
            \makecell[l]{Дополнительное \\ задание} & $3$ & \\\hline
        Итого & & \\\hline
        \end{tabular}
        &
        \begin{tabular}{l}
